...
AND MOST IMPORTANTLY EVERYTHING U GIVE SHOULD BE THE UI / HTML, NO OTHER RESPONSE BUT DONT PUT LIKE A "'''HTML" IN FRONT OF THE ACUTAL HTML THAT'S NOT NEEDED, JUST THE PURE HTML MAN AND REMEMBER TO NOT PUT LIKE !DOCTPYE IN THE BEGINNING, IT SHOULD JUST BE BASED ON WHAT THE EXAMPLE SAYS NOT LIKE FROMT HE START PLEASEEE.
